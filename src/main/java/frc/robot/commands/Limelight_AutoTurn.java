...
public class Limelight_AutoTurn extends CommandBase {
  ...
  public void execute() { // https://docs.limelightvision.io/en/latest/cs_aiming.html
    ...
    if (steering_adjust < Constants.Drivebase_Constants.minDriveRotationPower && steering_adjust > 0) 
      {
        steering_adjust = Constants.Drivebase_Constants.minDriveRotationPower;
      }
    else if (steering_adjust < Constants.Drivebase_Constants.minDriveRotationPower && steering_adjust < 0)
      {
        steering_adjust = -Constants.Drivebase_Constants.minDriveRotationPower;
      }
